    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('role:admin')
            ...
            ->group(function () {
                ...
                Route::get(
                    '/exports/class-checkins',
                    [ExportController::class, 'exportClassCheckins']
                )->name('admin.exports.class-checkins');

                Route::get(
                    '/exports/student-recap',
                    [ExportController::class, 'exportStudentRecap']
                )->name('admin.exports.student-recap');
